...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002043538118"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/siredaharami/MUSIC_USERBOT",
)
...
# Auto Gcast/Broadcast Handler (True = broadcast on , False = broadcast
# off During Hosting, Dont Do anything here.)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/15c3928ed732622af80d7.jpg"
)
PING_IMG_URL = getenv(
