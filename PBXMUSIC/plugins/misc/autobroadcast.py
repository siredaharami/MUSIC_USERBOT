...
from PBXMUSIC.utils.database import get_served_chats
    ...
    [
        [
            InlineKeyboardButton(
                "๏ ᴛᴀᴘ ᴛᴏ ꜱᴇᴇ ᴍᴀɢɪᴄ  ๏",
                url=f"https://t.me/MissBroken_Bot?startgroup=s&admin=delete_messages+manage_video_chats+pin_messages+invite_users",
            )
        ]
    ]
)
