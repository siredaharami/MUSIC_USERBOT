...
from PBXMUSIC.utils.decorators.play import PlayWrapper
...
@app.on_callback_query(filters.regex("PBXmousAdmin") & ~BANNED_USERS)
async def PBXmous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("PBXPlaylists") & ~BANNED_USERS)
@languageCB
...
import config
from PBXMUSIC import Carbon, YouTube, app
from PBXMUSIC.core.call import PBX
